...
name_label = Label(window, text = 'Name:', fg = 'black', bg = 'yellow')
name_label.grid(row = 1, column = 0, padx = 10, pady = 5)

name_entry = Entry(window, fg = 'white', bg = 'green', width = 25)
name_entry.grid(row = 1, column = 1, padx = 10, pady = 5)

hobby_label = Label(window, text = 'Hobby:', fg = 'black', bg = 'yellow')
hobby_label.grid(row = 2, column = 0, padx = 10, pady = 5)

hobby_entry = Entry(window, fg = 'white', bg = 'green', width = 25)
hobby_entry.grid(row = 2, column = 1, padx = 10, pady = 5)

about_frame = Frame(window, relief = 'raised', width = 3)
...
submit = Button(window, text = 'Submit', fg = 'white', bg = 'purple', width = 20)
